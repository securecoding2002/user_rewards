...
public class RewardControllerTest {
  ...
  public void getRewards_NoUser_404Returned() throws Exception {
    mvc.perform(
            MockMvcRequestBuilders.get("/rewards/not-present").accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isNotFound());
  }

  @Test
  public void getRewards_UserWithNoTransaction_200ReturnedWithZeroTotal() throws Exception {
    UserV1 user = UserV1.builder().userId("newId").userName("name").build();
    userService.addUser(user);
    mvc.perform(MockMvcRequestBuilders.get("/rewards/newId").accept(MediaType.APPLICATION_JSON))
  ...
  public void getRewards_UserWithNoTransaction_200ReturnedWithValidTotal() throws Exception {
    ...
    mvc.perform(MockMvcRequestBuilders.get("/rewards/123").accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
